...
var texts = [
  ...
  "Росіяни швидко просуваються на заході, сході і півночі міста, контролюють усі дороги, що ведуть у місто",
  "Тривають масовані обстріли більшості мікрорайонів міста і бойові зіткнення у різних частинах міста",
  "Ворог наближається до центру. Спроби евакуації мирних жителів зриваються через масовані обстріли росіян",
